...
/* # for 0.4.2.6 Approximate date when this software was released. (Updated
   when the version changes.) */
#define APPROX_RELEASE_DATE "2020-01-30"

/* tor's build directory */
#define BUILDDIR "/projects/tor/tor-0.4.2.6"
...
#define PACKAGE_STRING "tor 0.4.2.6"
...
#define SRCDIR "/projects/tor/tor-0.4.2.6"
